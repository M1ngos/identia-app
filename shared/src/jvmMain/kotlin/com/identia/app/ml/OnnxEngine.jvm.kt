...
/**
 * JVM desktop implementation, backed by the ONNX Runtime Java API
 * (`ai.onnxruntime`, via `onnxruntime`).
 *
 * NOTE: byte-for-byte identical to the Android actual in
 * `OnnxEngine.android.kt` — keep the two in sync. (No shared JVM/Android source
 * set exists here because a manual intermediate set disables the default KMP
